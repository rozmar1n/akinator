...
СFLAGS = -D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations \
		 ...
		 -Werror=vla -fsanitize=address,alignment,bool,bounds,enum,float-cast-overflow,float-divide-by-zero,integer-divide-by-zero,leak,nonnull-attrib \
		 ute,null,object-size,return,returns-nonnull-attribute,shift,signed-integer-overflow,undefined,unreachable,vla-bound,vptr 

all: main.o bin_tree/bin_tree.o Stack/Stack.o akinator.o
	$(CXX) main.o bin_tree/bin_tree.o akinator.o Stack/Stack.o -o akinator $(CFLAGS)
